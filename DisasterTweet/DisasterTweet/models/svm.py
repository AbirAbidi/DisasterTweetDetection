...
# Assuming your 'data' dataframe contains the necessary columns
X = data['processed_text_no_stopwords']  # Features
y = data['target']  # Replace with your target column name (e.g., sentiment, class, etc.)
...
#y_pred_svm = model_svm.predict(X_test_tfidf)
    ...
    #prediction = model_svm.predict(tweet_vectorized)
with open('svm.pkl', 'wb') as model_file:
    pickle.dump((model_svm, vectorizer), model_file)
