...
X_text = vectorizer.fit_transform(data['processed_text_no_stopwords'])
X = X_text 
y = data['target']
...
with open('log_reg_and_vectorizer.pkl', 'wb') as model_file:
    pickle.dump((logRegModel, vectorizer), model_file)
